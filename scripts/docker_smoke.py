...
def assert_runtime_has_no_dev_tools(
    docker: str,
    container: str,
) -> None:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--skip-build",
        action="store_true",
        help="use an existing image",
    )

    parser.add_argument(
        "--keep-image",
        action="store_true",
        help="do not remove the image",
    )
...
def main() -> int:
    ...
    try:
        ...
        assert_runtime_has_no_dev_tools(
            docker,
            container,
        )
        ...
        print(
            ...
            "the runtime contains no dev tools and no external network or "
            "writes were enabled."
        )
