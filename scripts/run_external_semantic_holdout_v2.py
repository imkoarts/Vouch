"""Run an auditor-supplied hybrid-semantic holdout against a frozen release candidate.
...
async def _run_case(case: HoldoutCase) -> tuple[SemanticInspectionResult, int]:
