...
from scripts.run_external_semantic_holdout_v5 import (
    HoldoutDocument,
...
def test_v5_runner_exposes_request_local_coverage_items() -> None:
...
def test_v5_runner_provider_case_uses_current_item_identity() -> None:
    source = "The incident left two workers too unsteady to walk."
